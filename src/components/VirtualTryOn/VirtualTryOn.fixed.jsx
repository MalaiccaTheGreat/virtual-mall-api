...
// Add prop types for ModelViewer
            ...
            <VStack spacing={6} align="stretch">
              ...
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6}>
                ...
                <Box 
                  ...
                  borderWidth="1px"
                  borderRadius="md"
                  borderColor={frontImage ? 'blue.300' : 'gray.200'}
                >
                  <input
                    type="file"
                    accept="image/*"
                ...
                <Box 
                  ...
                  borderWidth="1px"
                  borderRadius="md"
                  borderColor={sideImage ? 'blue.300' : 'gray.200'}
                >
                  <input
                    type="file"
                    accept="image/*"
                    ...
                    style={{ display: 'none' }}
                    disabled={isProcessing}
                    aria-label="Upload side view photo"
                  />
                  {sideImage ? (
                    <Box className="upload-preview" position="relative">
                      <img 
...
// Set default props
VirtualTryOn.defaultProps = VirtualTryOnDefaultProps;
