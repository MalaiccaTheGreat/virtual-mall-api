...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Virtual Mall') }}</title>
        ...
        <link rel="icon" type="image/png" sizes="96x96" href="{{ asset('build/assets/images/favicon-96x96.png') }}">
        <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('build/assets/images/pwa-192x192.png') }}">
        <link rel="icon" type="image/png" sizes="512x512" href="{{ asset('build/assets/images/pwa-512x512.png') }}">
