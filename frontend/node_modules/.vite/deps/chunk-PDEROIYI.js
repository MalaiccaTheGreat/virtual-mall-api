...
var require_use_sync_external_store_shim_production = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.production.js"(exports) {
    ...
    var useState4 = React4.useState;
    var useEffect4 = React4.useEffect;
    var useLayoutEffect3 = React4.useLayoutEffect;
    ...
    module.exports = function($$$config) {
      ...
      function resolveClassComponentProps(Component3, baseProps) {
        ...
        if (Component3 = Component3.defaultProps) {
          ...
          for (var propName$54 in Component3)
            void 0 === newProps[propName$54] && (newProps[propName$54] = Component3[propName$54]);
        }
        return newProps;
      }
      ...
      function updateClassComponent(current, workInProgress2, Component3, nextProps, renderLanes2) {
        ...
        if (null === workInProgress2.stateNode) {
          var context2 = emptyContextObject, contextType = Component3.contextType;
          "object" === typeof contextType && null !== contextType && (context2 = readContext(contextType));
          context2 = new Component3(nextProps, context2);
          ...
          var oldContext = context2.context, contextType$jscomp$0 = Component3.contextType;
        ...
        context2 || nextProps ? (context2 = workInProgress2.stateNode, Component3 = nextProps && "function" !== typeof Component3.getDerivedStateFromError ? null : context2.render(), workInProgress2.flags |= 1, null !== current && nextProps ? (workInProgress2.child = reconcileChildFibers(
          workInProgress2,
          current.child,
          null,
          renderLanes2
          ...
          Component3,
          renderLanes2
        )) : reconcileChildren(current, workInProgress2, Component3, renderLanes2), workInProgress2.memoizedState = context2.state, current = workInProgress2.child) : current = bailoutOnAlreadyFinishedWork(
          current,
          workInProgress2,
          renderLanes2
        );
      ...
      function recursivelyTraverseMutationEffects(root$jscomp$0, parentFiber) {
        ...
        if (null !== deletions)
          for (var i3 = 0; i3 < deletions.length; i3++) {
            var childToDelete = deletions[i3], root = root$jscomp$0, returnFiber = parentFiber;
            if (supportsMutation) {
        ...
        for (parentFiber = parentFiber.child; null !== parentFiber; ) {
          ...
          switch (deletions.tag) {
            ...
            case 22:
              ...
              i3._visibility & 4 && (i3._visibility &= -5, recursivelyTraverseDisconnectPassiveEffects(deletions));
              break;
            default:
              recursivelyTraverseDisconnectPassiveEffects(deletions);
          }
...
function createReconciler(config) {
  ...
  reconciler2.injectIntoDevTools({
    bundleType: typeof process !== "undefined" && false ? 1 : 0,
...
react-reconciler/cjs/react-reconciler.production.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PDEROIYI.js.map
